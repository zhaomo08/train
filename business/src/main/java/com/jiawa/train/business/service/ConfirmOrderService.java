...
//        // setIfAbsent就是对应redis的setnx
        Boolean setIfAbsent = redisTemplate.opsForValue().setIfAbsent(lockKey, lockKey, 30, TimeUnit.SECONDS);
...
//            }
        ...
        if (StrUtil.isNotBlank(ticketReq0.getSeat())) {
            ...
            getSeat(finalSeatList,
                    ...
                    , ticketReq0.getSeat().split("")[0],    // 从 A1 得到 A
                    offsetList,
...
//        }
     ...
     * 计算某座位在区间内是否可卖
     * 10001   0-1  4-5 已售卖
     * 例： sell = 10001  本次购买区间站1~4 则 区间已售000
     * 全部是 0 表示这个区间可买; 只要有1 就表示区间内已售过票
     * 选中后 要计算购票后的sell 比如原来是 10001 本次购买区间 1~4
     * 方案： 构造本次购票造成的售卖信息01110  和原 sell 10001 按位与,最终得到11111
     *
